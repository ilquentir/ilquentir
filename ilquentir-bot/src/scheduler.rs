...
pub fn create_chart(poll_stats: &[PollStat]) -> Result<String> {
    ...
    let series = vec![
        minus_two / total, minus_two / total, minus_two / total,
        minus_one / total, minus_one / total, minus_one / total,
        zero / total, zero / total, zero / total,
        plus_one / total, plus_one / total, plus_one / total,
        plus_two / total, plus_two / total, plus_two / total,
        0.0
    ];
